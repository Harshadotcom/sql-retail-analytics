...
INSERT INTO customer (email, full_name, joined_at) VALUES
  ('ananya@example.com', 'Ananya Rao', '2024-01-05 09:00:00'), ('rahul@example.com', 'Rahul Shah', '2024-02-11 09:00:00'),
  ('meera@example.com', 'Meera Iyer', '2024-03-09 09:00:00'), ('arjun@example.com', 'Arjun Nair', '2024-04-02 09:00:00');
...
INSERT INTO sales_order (customer_id, store_id, order_date, status) VALUES
  (1,1,'2024-05-01 09:00:00','paid'), (2,1,'2024-05-01 10:00:00','paid'),
  (1,2,'2024-05-15 14:00:00','paid'), (3,2,'2024-06-02 11:00:00','paid'),
  (2,1,'2024-06-05 16:00:00','cancelled'), (4,1,'2024-06-12 08:30:00','paid');
